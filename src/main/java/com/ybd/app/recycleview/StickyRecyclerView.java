package com.ybd.app.recycleview;
 ...
 *
 * @Override public String getItemViewTitle(int position) {
...
public class StickyRecyclerView extends RecyclerView {
        ...
        public void onDraw(Canvas c, RecyclerView parent, State state) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (!adapter.needTitle(position)) {
                    ...
                    c.drawRect(left, top, right, bottom, paint);
                    drawText(c, adapter.getItemViewTitle(position), left + titleHeight * 0.25f, bottom - titleHeight
                            * 0.25f);
                }
            }
        }
    ...
    public static abstract class StickyAdapter extends Adapter {
        ...
        boolean needTitle(int position) {
            return position > -1 && (position == 0 || !getItemViewTitle(position).equals(getItemViewTitle(position -
                    1)));
        }
    }
